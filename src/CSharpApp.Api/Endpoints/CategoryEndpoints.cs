...
namespace CSharpApp.Api.Endpoints
{
    public static class CategoryEndpoints
    {
        ...
        {
            endpoints.MapGet("api/v{version:apiVersion}/categories",
            ...
            endpoints.MapGet("api/v{version:apiVersion}/categories/{id:int}",
            ...
            endpoints.MapPost("api/v{version:apiVersion}/categories",
            ...
            endpoints.MapPut("api/v{version:apiVersion}/categories/{id:int}",
